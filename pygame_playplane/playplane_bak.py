...
shootMusic = pygame.mixer.Sound('./bullet.wav')

level_up_music = pygame.mixer.Sound('./bullet.wav')
...
backgroundMusic = pygame.mixer.music.load('./game_music.wav')
pygame.mixer.music.play(-1, 0.0)

enemy_shoot_sound = pygame.mixer.Sound('./enemy3_down.wav')
...
gameOver_music = pygame.mixer.music.load('./game_over.wav')
